...
Before activation, attach evidence for: an independent audit and remediation; counsel-approved jurisdiction, eligibility, sanctions, terms, privacy and data-retention rules; verified checksummed contract/RPC/oracle addresses; production Chainlink Data Streams v11 stream IDs and authenticated report retrieval; Safe signers and threshold; two-day timelock roles and ownership; source verification; staging fork/canary results; load-test latency/error results; database backup/restore; dashboards and paging; incident rehearsal; final product name/trademark and current Robinhood brand-guideline review.
