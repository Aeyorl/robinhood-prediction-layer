# Historical first market package — NVDA closing price — 2026-09-13

Superseded and expired: do not import or sign the calldata below. The proposed 20 USDG total cap is withdrawn at the owner's request; no global pool cap exists in the deployed contract. The encoded historical transaction is retained only as a record.
...
| Historical entry limits | `minEntry=1000000` (1 USDG), `maxEntry=10000000` (10 USDG) per user per side. No total pool cap.                                                                                                                                                                                                                                                       |
